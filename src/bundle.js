(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('topojson')) :
  typeof define === 'function' && define.amd ? define(['topojson'], factory) :
  (global = global || self, factory(global.topojson));
}(this, (function (topojson) { 'use strict';
  ...
  ////MAP 만들기 ////////////////////////////////////////////////////////////////////
  //모눈종이
  var svgForMap = select("map").append("svg");
  svgForMap.attr("height", height).attr("width", width);
  var map$2 = svgForMap.append("g").attr("id", "map"), places = svgForMap.append("g").attr("id", "places");
  var projection$1 = mercator()
      .center([126.9895, 37.5651])
      .scale(1000)
      .translate([width / 2, height / 2]);
  var path = index().projection(projection$1);
  ...
  projection$1.scale(scale).translate([xoffset, yoffset]);
  console.log(geojson);
  var center$1 = centroid(geojson);
  map$2
      .selectAll("path")
